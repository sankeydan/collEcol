...
#' @param data data frame or list of data frames with dimensions time (rows), longitude / latitude (in that order; columns) & individual (3rd dimension). No third dimension necessary for solo plots.
...
plot_map = function( data,  type = c("solo", "group") , image.or.vid = "image",
                     ...
                     lines.or.points = "lines", col = "red" , axis.nums.size = 12, axis.labs.size = 14,
